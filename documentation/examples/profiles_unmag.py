...
filename = os.path.join(cwd,'rho_b-6_unmag.png')
...
plt.xlim(0,15)
plt.legend(fontsize=15)
filename = os.path.join(cwd,'p_b-6_unmag.png')
fig.savefig(filename, format='png', dpi=100, bbox_inches='tight')
plt.show()
...
# plt.xlim(0,100)
plt.legend(fontsize=15)
filename = os.path.join(cwd,'psi_b-6_unmag.png')
fig.savefig(filename, format='png', dpi=100, bbox_inches='tight')
plt.show()
...
# plt.xlim(0,100)
plt.legend(fontsize=15)
filename = os.path.join(cwd,'alpha_b-6_unmag.png')
fig.savefig(filename, format='png', dpi=100, bbox_inches='tight')
plt.show()
...
# plt.xlim(0,100)
plt.legend(fontsize=15)
filename = os.path.join(cwd,'chi_b-6_unmag.png')
fig.savefig(filename, format='png', dpi=100, bbox_inches='tight')
plt.show()

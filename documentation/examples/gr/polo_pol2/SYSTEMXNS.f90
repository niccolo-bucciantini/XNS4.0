...
! ====================================================================================
  ...
  REAL :: REQMAX = 13.5      ! Truncation radius for equilibrium solution (to avoid explosion)
...
! ====================================================================================
  ...
  REAL :: BETA0 = 0.0!-6.0   		   	! Beta0 parameter for the scalar field
...
! ====================================================================================
  ...
  REAL :: KBPOL =  0.34135  !0.2                ! Magnetic coefficient

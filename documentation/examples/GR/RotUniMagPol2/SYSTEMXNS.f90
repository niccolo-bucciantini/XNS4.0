MODULE SYSTEMXNS
  ...
  INTEGER :: MAXLOOP = 1000                 ! Max Number of loops for convergence in XNSMAIN (1 = TOV solution)
  ...
  REAL :: REQMAX = 15.00               ! Truncation radius for equilibrium solution (to avoid explosion)
  ...
  REAL,PARAMETER :: RHOINI = 6.945e-4 ! Central density in the Jordan frame (beware scheme converges to QUCONV)
  ...
  REAL :: KBPOL = 0.3973242                    ! Magnetic coefficient
  ...
  REAL :: QFACTOR = 0.5       ! Damping factor for press the convergence loop  qnew = qfactro*qnew + (1-qfactor)*qold
  ...
  REAL,PARAMETER    :: QAPHI = 0.3      ! Damping factor for the convergence of the vector and scalalr potential
  ...
  INTEGER,PARAMETER :: MLST = 10     ! Number of Legendre polinomia used to solve Maxwell-Gauss equation

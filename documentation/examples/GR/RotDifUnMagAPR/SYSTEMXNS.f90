MODULE SYSTEMXNS
  ...
  INTEGER,PARAMETER :: NR    = 500 ! Radial mesh points
  INTEGER,PARAMETER :: NTH   = 200 ! Angular mesh points (1 = 1D TOV solution)
  INTEGER,PARAMETER :: NRREG = 500       ! Points for the regular grid if stretch=.TRUE.
  ...
  LOGICAL        :: URYULAW3     = .TRUE.   ! Rotation law: Uryu with 3 Parameters
  LOGICAL        :: URYULAW4     = .FALSE.    ! Rotation law: Uryu with 4 Parameters
  REAL,PARAMETER :: OMG = 2.22E-2               ! Central Rotation rate
